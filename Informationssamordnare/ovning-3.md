---
description: Skriva till Excel
---

# Övning 3

Projektledaren vill ha en tydlig excell som beskriver leveransfilernas metadata.\
Din uppgift är att skriva resultatet av filerna till en Excel.

\
Utgå från Workspacet i övning 2

* Attribut-namnen vi har är otydliga och ibland överflödiga – använd transformers för att ta bort/behålla/ändra och döpa om attribut så vi får ett lättläst Excel!
...
* Formatera om ett datumattribut till År-Månad-Dag (2026-02-27)
  ...
  * För ditt datumattribut Value – open text editor – Date/Time\
    Functions
  * Använd Help – Date/Time Functions
